- Inspired by: BOJ 18870 (https://www.acmicpc.net/problem/18870)
...
<details>
  ...
  2. Extract the distinct values (e.g., using a set-like structure). Since such structures do not preserve order, convert the values into a sortable collection and sort them.
  ...
  5. Iterate through the original list, look up each value in the mapping, and collect the corresponding ranks in order.
