...
- Goal: generate and print all non-decreasing sequences of targetLength from distinct numbers

- Conditions:
  - Numbers may be chosen multiple times.
  - Each sequence must be in non-decreasing order.
  - The output must be printed in lexicographical order.
